...
class Director:
    ...
    def _get_inputs(self):
        ...
        guesss = self._console.read_number("What is your guess: ")
        move = Move(guesss)
    ...
    def _do_outputs(self):
        ...
        this case, that means checking if code is guessed and declaring the winner.

        Args:
            self (Director): An instance of Director.
        """

        if self._board.is_guessed() == "win":
